...
export function AuthButton({ user }: { user: { email?: string } | null }) {
  ...
  return (
    <button
      ...
      className="flex items-center gap-2 rounded-lg bg-zinc-900 dark:bg-zinc-50 text-white dark:text-zinc-900 px-5 py-2.5 text-sm font-medium hover:bg-zinc-800 dark:hover:bg-zinc-200 transition-colors"
    >
